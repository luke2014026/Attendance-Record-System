...
<html lang = "eng">
	<head>
		<title>ATTENDANCE SYSTEM 2022</title>
		<meta charset = "utf-8" />
	...
	<body>
		<nav class = "navbar navbar-inverse navbar-fixed-top">
			<div class = "container-fluid">
				<div class = "navbar-header">
					...
					<p class = "navbar-text pull-right">ATTENDANCE RECORD SYSTEM 2022</p>
				</div>
		...
		<div class = "container-fluid" style = "margin-top:70px;">
			<ul class = "nav nav-pills">
				<li class = "active"><a href = "home.php"><span class = "glyphicon glyphicon-home"></span> Home Page</a></li>
				<li class = "dropdown">
					...
					<ul class = "dropdown-menu">
						<li><a href = "admin.php"><span class = "glyphicon glyphicon-user"></span> teacher</a></li>
			...
			<br />
			<div class = "alert alert-info">Home Page</div>
		...
		<div class = "navbar navbar-fixed-bottom alert-warning">
			<div class = "container-fluid">
				<label class = "pull-left">&copy; ATTENDANCE RECORD SYSTEM 2022</label>
				<label class = "pull-right">Developer: CODERS</a></label>
			</div>	
		</div>	
	</body>
