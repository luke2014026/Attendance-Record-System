...
<html lang = "eng">
	...
	<body>
		<nav class = "navbar navbar-inverse navbar-fixed-top">
			<div class = "container-fluid">
				...
				<ul class = "nav navbar-nav navbar-right">
					<li class = "dropdown">
						<a href = "#" class = "dropdown-toggle" data-toggle = "dropdown"><i class = "glyphicon glyphicon-cog"></i> <?php echo htmlentities($admin_name)?> <b class = "caret"></b></a>
		...
		<div class = "container-fluid" style = "margin-top:70px;">
			...
			<div class = "alert alert-info">Accounts / teachers</div>
		...
		<div class = "navbar navbar-fixed-bottom alert-warning">
			<div class = "container-fluid">
				<label class = "pull-left">&copy; ATTENDENCE SYSTEM 2022</label>
				<label class = "pull-right">Developer: COODERS </a></label>
			</div>	
		</div>	
	</body>
